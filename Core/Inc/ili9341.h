...
#include <stdbool.h>
#include "main.h"
#define COLOR_TRANSPARENTE 0x0000
void LCD_Init(void);
...
void LCD_SpriteTransparent(int x, int y, int width, int height, const uint16_t *bitmap, int columns, int index, uint16_t transparentColor);
